...
EdgeData* TwoEdgeConnectivity::insert(int u, int v) {
    ...
    EdgeData* edge = EdgeData::new_non_tree_edge(u, v, 0);
...
EdgeData* TwoEdgeConnectivity::insert(int u, int v, int level) {
    ...
    EdgeData* edge = EdgeData::new_non_tree_edge(u, v, level);
    this->add_label(u, edge);
    this->add_label(v, edge);
...
void TwoEdgeConnectivity::add_label(int vertex, EdgeData* edge) {
...
void TwoEdgeConnectivity::remove_labels(EdgeData* edge) {
    ...
    for (int i = 0; i < 2; i++) {
        ...
        EdgeData* last_label = ep_label->labels[level].back();
...
void TwoEdgeConnectivity::remove(EdgeData* edge) {
...
EdgeData* TwoEdgeConnectivity::swap(EdgeData* tree_edge) {
...
EdgeData* TwoEdgeConnectivity::find_replacement(int u, int v, int cover_level) {
...
EdgeData* TwoEdgeConnectivity::find_first_label(int u, int v, int cover_level) {
    EdgeData* res;
...
EdgeData* TwoEdgeConnectivity::recover_phase(int u, int v, int cover_level, int size) {
    EdgeData* label = this->find_first_label(u, v, cover_level);
    int i = 0;
    while (label) {
