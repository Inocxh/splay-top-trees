...
void TwoEdgeCluster::create_find_size(EdgeData* edge_data, VertexLabel* left, VertexLabel* right)  {
...
void TwoEdgeCluster::destroy_find_size(EdgeData* edge_data, VertexLabel* left, VertexLabel* right)  {
